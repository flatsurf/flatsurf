...
#define LIBFLATSURF_FLAT_TRIANGULATION_COLLAPSED_TYPES BOOST_PP_SEQ_FOR_EACH_PRODUCT(LIBFLATSURF_SURFACE_TYPE_TEMPLATES_WRAP, ((FlatTriangulationCollapsed))(LIBFLATSURF_REAL_TYPES))
