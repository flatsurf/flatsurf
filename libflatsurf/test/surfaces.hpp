...
inline auto make1072221Combinatorial() {
  auto vertices = vector<vector<int>>{{1, -3, -9, -20, -40, -64, 48, 26, 12, -13, -28, -50, 54, 30, 14, 6, -7, -17, -34, -57, 44, 23, 10, 4}, {-1, -5, -12, 16, 7, 2}, {-2, -6, -15, -32, 27, 13, 5, -4, -11, -25, 33, 17, -16, -26, 36, 18, 8, 3}, {-8, -19, -38, -61, 58, 34, -33, -47, -68, 70, 51, 28, -27, -49, 65, 41, 21, 9}, {-10, -22, -43, 55, 31, 15, -14, -29, -53, 59, 35, -36, -48, -69, 67, 46, 24, 11}, {-18, -35, -60, 49, 32, -31, -56, 47, 25, -24, 37, 19}, {20, -21, -42, 22, -23, -45, 50, -51, -71, 69, 64, -63, 57, -58, 52, 29, -30, 39}, {-37, -46, 66, -65, 60, -59, -72, 68, 56, -55, 62, 38}, {-39, -54, 45, -44, 63, 40}, {-41, -66, -67, 71, -70, 72, 53, -52, 61, -62, 43, 42}};
  return std::make_shared<FlatTriangulationCombinatorial>(vertices);
}
...
auto make1072221() {
  vector<R2> vectors;
  auto a = K->gen();
  vectors = {R2(a, -1), R2(0, 4), R2(-a, -3), R2(-a, -3), R2(2 * a, 2), R2(-a, 3), R2(a, 1), R2(-a - 2, -3), R2(2, 0), R2(-1, a), R2(-a + 1, -a - 3), R2(0, 2), R2(2 * a, 0), R2(2, 0), R2(-a - 2, 3), R2(2 * a, -2), R2(-a, 3), R2(-3 * a, -3), R2(2 * a - 2, 0), R2(-a, 3), R2(a + 2, -3), R2(-2 * a - 1, a), R2(2 * a, 0), R2(-a + 1, -a + 3), R2(0, -6), R2(2 * a, 0), R2(2 * a + 1, -a), R2(-1, a), R2(a + 2, 3), R2(-a, -3), R2(2 * a - 2, 0), R2(-3 * a, 3), R2(-a + 1, a + 3), R2(-1, -a), R2(-a + 1, a - 3), R2(-2 * a - 1, -a), R2(3 * a - 3, a - 3), R2(-a + 1, -a + 3), R2(0, 4), R2(-a, -1), R2(-2 * a + 2, 0), R2(3 * a, -3), R2(a - 1, a - 3), R2(0, -2), R2(2 * a, 2), R2(2 * a - 2, 0), R2(-a + 1, a - 3), R2(-1, -a), R2(-a + 1, -a + 3), R2(-a, -3), R2(a - 1, a + 3), R2(3 * a, 3), R2(-2 * a + 2, 0), R2(-a, 1), R2(-a + 1, a - 3), R2(3 * a - 3, -a + 3), R2(2 * a, 0), R2(-2 * a - 1, -a), R2(-a + 1, -a + 3), R2(0, 2 * a - 6), R2(-a + 1, a - 3), R2(0, -2 * a + 6), R2(-2 * a, 2), R2(a, -3), R2(a - 1, -a + 3), R2(-3 * a + 3, a - 3), R2(-a + 1, a - 3), R2(2 * a - 2, 0), R2(a - 1, -a - 3), R2(a - 1, a - 3), R2(0, 6), R2(-3 * a + 3, -a + 3)};
