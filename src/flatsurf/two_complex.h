...
#ifndef FLATSURF_TWOCOMPLEX_H
#define FLATSURF_TWOCOMPLEX_H
...
class TwoComplex {
 public:
  ...
  explicit operator flatsurf::FlatTriangulation<
      flatsurf::VectorExactReal<exactreal::NumberFieldTraits>>() const;
