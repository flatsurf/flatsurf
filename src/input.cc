...
//    std::cout << "check PI: " << sinl(MY_PI) << endl;
    ...
    bigrat ptemp[6] = {bigrat(-2,3), bigrat(2,1), bigrat(-2,1), bigrat(4,3),
bigrat(-2,1), 0}; bigrat qtemp[6] = {0, bigrat(2, 1), bigrat(-2,1), bigrat(2,
1), bigrat(-2, 1), 0}; algebraic p_alg(ptemp, S->field), q_alg(qtemp, S->field);
