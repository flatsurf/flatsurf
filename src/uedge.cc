...
namespace polygon {
UEdge::UEdge(Vertex* a, Vertex* b, BigPointQ vec, const TwoComplex& complex)
    : Simplex(complex), ue_vecQ(vec) {
  tag = 'E';
  v0 = a;
  v1 = b;
  f0 = f1 = nullptr;
...
UEdge::UEdge(Vertex* a, Vertex* b, Point vec_cx, const TwoComplex& complex)
    : Simplex(complex) {
  if (field_arithmetic) {
