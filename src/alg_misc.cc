...
bool is_alg_quotient(const alg_t<int64_t> &p1, const alg_t<int64_t> &p2, algebraicQ& ratio)  //if p1/p2 is algebraic, return true and put it in ratio. 
{

//    out_s << endl << "In is_alg_quotient, p1 = " << p1 << " p2 = " << p2 << endl;
