 ...
 *********************************************************************/
#ifndef LIBPOLYGON_VECTOR_ALONG_TRIANGULATION
#define LIBPOLYGON_VECTOR_ALONG_TRIANGULATION
...
namespace flatsurf {
	...
	template<typename V>
	struct VectorAlongTriangulation : boost::additive<VectorAlongTriangulation<V>>, boost::additive<VectorAlongTriangulation<V>, HalfEdge>, boost::less_than_comparable<VectorAlongTriangulation<V>, Bound> {
